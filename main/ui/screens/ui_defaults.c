...
static const char *TAG = "ui_defaults";

lv_obj_t *ui_Defaults;
...
{
    _ui_screen_delete(&ui_Defaults);
}

void ui_Defaults_screen_init(void)
{
    ui_Defaults = lv_obj_create(NULL);

    lv_obj_clear_flag(ui_Defaults, LV_OBJ_FLAG_SCROLLABLE); /// Flags
    lv_obj_set_style_bg_color(ui_Defaults, lv_color_hex(0x171726), 0);

    lv_obj_t *ui_LabelMenu = lv_label_create(ui_Defaults);
    // lv_label_
    lv_obj_align(ui_LabelMenu, LV_ALIGN_TOP_MID, 0, 29);
    lv_obj_set_style_text_font(ui_LabelMenu, &MiSansBold_26, 0);
    lv_label_set_text(ui_LabelMenu, "通用设置");
    lv_obj_set_style_text_color(ui_LabelMenu, lv_color_hex(0xffffff), 0);

    img_home = lv_img_create(ui_Defaults);
    ...
    img_leftarr = lv_img_create(ui_Defaults);
    ...
    white_btn = lv_btn_create(ui_Defaults);
    ...
    lv_label_set_text(ui_LabelButton, "音量设置");
    lv_obj_set_style_text_color(ui_LabelButton, lv_color_hex(0xFF8519), 0);

    white_btn2 = lv_btn_create(ui_Defaults);
    ...
    white_btn3 = lv_btn_create(ui_Defaults);
    ...
    white_btn4 = lv_btn_create(ui_Defaults);
    ...
    white_btn5 = lv_btn_create(ui_Defaults);
    ...
    white_btn6 = lv_btn_create(ui_Defaults);
    ...
    lv_obj_add_event_cb(ui_Defaults, event_unload_handler, LV_EVENT_SCREEN_UNLOADED,
                        NULL);
}