...
static const char *TAG = "ui_username";
...
void ui_Username_screen_init(void)
{
    ...
    img_leftarr = lv_img_create(ui_Username);
    ...
    white_btn = lv_btn_create(ui_Username);
    lv_obj_set_pos(white_btn, 72, 105);
    ...
    white_btn2 = lv_btn_create(ui_Username);
    lv_obj_set_pos(white_btn2, 292, 105);
    lv_obj_set_size(white_btn2, 114, 60);
    ...
    lv_label_set_text(ui_LabelButton2, "切换用户");
    lv_obj_set_style_text_color(ui_LabelButton2, lv_color_hex(0xFF8519), 0);

    white_btn3 = lv_btn_create(ui_Username);
    lv_obj_set_pos(white_btn3, 72, 197);
    ...
    lv_label_set_text(ui_LabelButton3, "注销账号");
    lv_obj_set_style_text_color(ui_LabelButton3, lv_color_hex(0xFFFFFF), 0);

    white_btn4 = lv_btn_create(ui_Username);
    lv_obj_set_pos(white_btn4, 292, 197);
    lv_obj_set_size(white_btn4, 114, 60);
    lv_obj_set_style_radius(white_btn4, 12, LV_PART_MAIN);
    lv_obj_set_style_bg_color(white_btn4, lv_color_hex(0xffffff), LV_PART_MAIN);
    lv_obj_set_style_bg_opa(white_btn4, LV_OPA_100, LV_PART_MAIN);
    ...
    lv_label_set_text(ui_LabelButton4, "注销");
    lv_obj_set_style_text_color(ui_LabelButton4, lv_color_hex(0x5E5E5E), 0);

    lv_obj_add_event_cb(ui_Username, event_unload_handler, LV_EVENT_SCREEN_UNLOADED,
                        NULL);
}