...
void ui_Menu_screen_init(void)
{
    ...
    lv_obj_set_style_bg_color(ui_Menu, lv_color_hex(0x171726), 0);

    lv_obj_t *ui_LabelMenu = lv_label_create(ui_Menu);
    // lv_label_
    lv_obj_align(ui_LabelMenu, LV_ALIGN_TOP_MID, 0, 29);
    lv_obj_set_style_text_font(ui_LabelMenu, &MiSansBold_26, 0);
    lv_label_set_text(ui_LabelMenu, "设置中心");
    lv_obj_set_style_text_color(ui_LabelMenu, lv_color_hex(0xffffff), 0);

    img_home = lv_img_create(ui_Menu);
    ...
    img_leftarr = lv_img_create(ui_Menu);
    ...
    white_btn = lv_btn_create(ui_Menu);
    lv_obj_set_pos(white_btn, 87, 105);
    lv_obj_set_size(white_btn, 156, 60);
    ...
    lv_label_set_text(ui_LabelButton, "用户中心");
    lv_obj_set_style_text_color(ui_LabelButton, lv_color_hex(0xFF8519), 0);

    white_btn2 = lv_btn_create(ui_Menu);
    lv_obj_set_pos(white_btn2, 255, 105);
    lv_obj_set_size(white_btn2, 156, 60);
    ...
    lv_label_set_text(ui_LabelButton2, "设备绑定");
    lv_obj_set_style_text_color(ui_LabelButton2, lv_color_hex(0xFF8519), 0);

    white_btn3 = lv_btn_create(ui_Menu);
    lv_obj_set_pos(white_btn3, 87, 197);
    lv_obj_set_size(white_btn3, 156, 60);
    ...
    lv_label_set_text(ui_LabelButton3, "网络设置");
    lv_obj_set_style_text_color(ui_LabelButton3, lv_color_hex(0xFF8519), 0);

    white_btn4 = lv_btn_create(ui_Menu);
    lv_obj_set_pos(white_btn4, 255, 197);
    lv_obj_set_size(white_btn4, 156, 60);
    ...
    lv_label_set_text(ui_LabelButton4, "通用设置");
    lv_obj_set_style_text_color(ui_LabelButton4, lv_color_hex(0xFF8519), 0);

    lv_obj_add_event_cb(ui_Menu, event_unload_handler, LV_EVENT_SCREEN_UNLOADED,
                        NULL);
}